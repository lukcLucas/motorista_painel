...
import { User, Phone, Car, Building, MapPin, KeyRound, Briefcase, Power, Search as SearchIcon, Activity, AlertTriangle } from 'lucide-react';
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="py-4 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-5">
            ...
            <DetailItem icon={<KeyRound />} label="Senha (Motorista - 3 dígitos)" value={driver.password ? driver.password : "Não definida"} />
          </div>
        </div>
