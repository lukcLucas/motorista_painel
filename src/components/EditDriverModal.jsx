...
import { Edit, Save, Power, Briefcase, AlertTriangle, Anchor } from "lucide-react";
...
export const EditDriverModal = ({ isOpen, onOpenChange, driver, onSave }) => {
  ...
  useEffect(() => {
    if (driver) {
      setFormData({ ...driver, serviceStatus: driver.serviceStatus || "disponivel", dock: driver.dock || "" });
    } else {
      setFormData(null);
    }
  }, [driver]);
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-4">
          <div className="grid grid-cols-1 gap-y-4 gap-x-4 sm:grid-cols-2">
            ...
            <div>
              <Label htmlFor="edit-dock">Doca</Label>
              <Input type="text" name="dock" id="edit-dock" value={formData.dock} onChange={handleChange} />
            </div>
            <div>
