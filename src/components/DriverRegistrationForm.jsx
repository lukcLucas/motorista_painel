...
import { UserPlus, User, Phone, Car, Building, MapPin, KeyRound, Briefcase, CheckCircle, AlertTriangle, Anchor } from 'lucide-react';
...
export function DriverRegistrationForm({ onRegistrationSuccess, logAction, userRole }) {
  ...
  const inputFields = [
    ...
    { name: "password", label: "Senha (3 dígitos numéricos)", placeholder: "Ex: 123", icon: <KeyRound className="h-4 w-4 text-gray-400" />, type: "text", maxLength: 3 },
    ...
    { name: "dock", label: "Doca", placeholder: "Ex: Doca 5A", icon: <Anchor className="h-4 w-4 text-gray-400" /> },
  ];
